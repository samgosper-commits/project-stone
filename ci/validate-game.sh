...
if grep -E 'SCRIPT ERROR:|Parse Error:|Failed to load script|Could not load editor settings' build/logs/import.log build/logs/smoke.log build/logs/scene-check.log; then
